 ...
 *
 * @module @ephemeral-ai/mayfly/core/terminal-escape
 */
...
export interface MayflyEscapeProcess {
  stdout: {
...
export interface MayflyClipboardTerminal {
 ...
 */
export function emitClipboardOsc52(text: string, proc: MayflyEscapeProcess = process): boolean {
...
export async function copySelectionText(
  text: string,
  terminal: MayflyClipboardTerminal,
