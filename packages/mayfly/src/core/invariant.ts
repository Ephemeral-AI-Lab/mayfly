/**
 * Package-owned invariant companion for `@ephemeral-ai/mayfly/core`.
 * @module @ephemeral-ai/mayfly/core/invariant
 */

import type { Context } from '@deepseek-ai/cordis'
import type { InvariantInstaller } from '@deepseek-ai/dsh-invariants'

const PACKAGE_NAME = '@ephemeral-ai/mayfly/core'

/** Cordis companion plugin name. */
export const name = 'mayfly-core-invariant'
