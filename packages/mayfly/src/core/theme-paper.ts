/**
 * `mayfly-theme-paper` plugin: the built-in paper palette — a warm light
 ...
 * `/theme paper` can replace `mayfly-theme-dark` fiber-for-fiber and
 * `mayfly-theme-custom` can use it as a base palette. The banner logo
 * carries an amber sweep so the mark follows the palette.
 *
 * @module @ephemeral-ai/mayfly/core/theme-paper
 */
...
/**
 * Provide the paper palette as `ctx.mayflyTheme`.
