/**
 * `mayfly-theme-ocean` plugin: the built-in ocean palette — a blue-tinted
 ...
 * entry so `/theme ocean` can replace `mayfly-theme-dark` fiber-for-fiber
 * and `mayfly-theme-custom` can use it as a base palette. The banner logo
 * carries a teal sweep so the mark follows the palette.
 *
 * @module @ephemeral-ai/mayfly/core/theme-ocean
 */
...
/**
 * Provide the ocean palette as `ctx.mayflyTheme`.
