 ...
 *
 * @module @ephemeral-ai/mayfly/frontend/theme
 */
import { Service, type Context } from '@deepseek-ai/cordis'
import type { ThemeModel } from './models.ts'

declare module '@deepseek-ai/cordis' { interface Context { mayflyThemeModels: ThemeModelService } }
...
export class ThemeModelService extends Service {
  ...
  constructor(ctx: Context) { super(ctx, 'mayflyThemeModels') }
