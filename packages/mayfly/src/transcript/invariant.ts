/**
 * Package-owned invariant companion for `@ephemeral-ai/mayfly/transcript`.
 * @module @ephemeral-ai/mayfly/transcript/invariant
 */

import type { Context } from '@deepseek-ai/cordis'
import type { InvariantInstaller } from '@deepseek-ai/dsh-invariants'

const PACKAGE_NAME = '@ephemeral-ai/mayfly/transcript'

/** Cordis companion plugin name. */
export const name = 'mayfly-transcript-invariant'
