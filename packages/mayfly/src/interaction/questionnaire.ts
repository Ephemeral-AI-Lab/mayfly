/**
 * Canonical multi-question controller for `mayfly-questions`. It retains the
 * answer state machine, drafts, and key mapping while projecting every view
 * through Mayfly UI list/form/surface nodes.
 *
...
export class Questionnaire implements MayflyFocusable {
  ...
  currentNode(): MayflyUiNode {
    ...
    const body: MayflyUiNode[] = [
      ...
      { kind: 'rich-text', spans: [{ text: question.question, tone: 'accent', styles: ['strong'] }] },
