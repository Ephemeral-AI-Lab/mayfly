...
const zh: Readonly<Record<string, string>> = {
  ...
  'Toggle a checkbox or multi-select row, open a multiselect, or fold a tree branch': '切换复选框或多选行、打开多选字段，或折叠树节点',
  'Move to the next or previous control group, committing text and pickers': '移动到下一个或上一个控件组，并提交文本和选择器',
  'Leave the innermost layer: picker, editing, search, back, then close': '退出最内层：选择器、编辑、搜索、返回，最后关闭',
  'Close the surface, asking first when there are unsaved changes': '关闭面板；有未保存修改时先确认',
  ...
  'custom is the derived state — pick a preset': 'custom 是推导出的状态，请选择一个预设',
  'permission target changed; action cancelled': '权限目标已变化，操作已取消',
  ...
  'Stop': '停止',
  'Its live Agent shuts down; the stored conversation stays browsable.': '其运行中的 Agent 将关闭，已保存的对话仍可浏览。',
  'Only continuable subagents can be stopped': '只能停止可继续的子 Agent',
  'Not live; there is nothing to stop': '未在运行，无需停止',
  'Stop its live descendants first': '请先停止其运行中的下级 Agent',
  ...
  'Model "{model}" added — save to persist': '已添加模型“{model}”——保存后生效',
  'Already listed': '已在列表中',
  '+ model id': '+ 模型 id',
  'model id': '模型 id',
  'discovering models…': '正在发现模型…',
  'model discovery unavailable — add models by id below': '模型发现不可用——可在下方按 id 添加',
  '{count} models': '{count} 个模型',
  'no models': '无模型',
  'key configured': '已配置密钥',
  'no key set': '未设置密钥',
  'Model ID': '模型 ID',
  ...
  'Transcript detail': '对话详情级别',
  'Thinking detail': '思考内容详情',
  'Command detail': '命令执行详情',
  'Read detail': '文件读取详情',
  'Search detail': '搜索详情',
  'Edit detail': '文件编辑详情',
  'Web detail': '网络访问详情',
  ...
  'Schedule tools bind when the Agent is created; this session cannot gain them through /preset. Run /new {preset} for a session that has them.': '提醒工具在 Agent 创建时绑定，本会话无法通过 /preset 获得。请运行 /new {preset} 新建一个带提醒工具的会话。',
  'Schedule tools bind when the Agent is created; /preset cannot remove them from this session. Run /new {preset} for a session without them.': '提醒工具在 Agent 创建时绑定，/preset 无法将其从本会话移除。请运行 /new {preset} 新建一个不含提醒工具的会话。',
  'unknown agent preset {preset}': '未知的 Agent 预设 {preset}',
  ...
  'Plan review': '计划评审',
  'Copy plan': '复制计划',
  'Plan copied to clipboard': '计划已复制到剪贴板',
  'Plan copy failed': '计划复制失败',
  'Type feedback to revise the plan': '输入反馈以修改计划',
  'Tell the model what to change': '告诉模型需要改动什么',
  'Feedback': '反馈',
  'Submit': '提交',
  'PgUp/PgDn · ⇧↑↓ scroll plan': 'PgUp/PgDn · ⇧↑↓ 滚动计划',
  'Revise': '修改',
  'Next': '下一题',
  'Back': '返回',
  'Submit answers': '提交回答',
  ...
  'Close': '关闭',
  'Set as default': '设为默认',
  'Use for this session': '仅用于本次会话',
  'Select a model': '选择模型',
  'No models advertised': '没有可用模型',
  'The model is no longer available': '模型已不可用',
  'Refresh': '刷新',
  ...
  'kill': '终止',
  '(no output yet)': '（还没有输出）',
  '(earlier output was dropped by retention)': '（更早的输出已被保留窗口丢弃）',
  ...
  'q back': 'q 返回',
  'Reminders': '提醒',
  'Reminders {count}': '{count} 个提醒',
  'Inspect session-local reminders': '查看会话内提醒',
  'Schedule unavailable': '提醒不可用',
  'No active reminders': '没有活动提醒',
  'Scheduled': '等待中',
  'Overdue': '已逾期',
  'Once': '单次',
  'Every {value} {unit}': '每{value}{unit}一次',
  'day': '天',
  'days': '天',
  'hour': '小时',
  'hours': '小时',
  ...
  '{value} {unit} overdue': '已逾期 {value}{unit}',
  'Delivery requires a live root session. Create or cancel reminders through the conversation; the Agent preset decides whether reminder tools exist.': '投递需要存活的 root 会话。通过对话创建或取消提醒；Agent 预设决定是否提供提醒工具。',
  'The Schedule capability is mounted per Agent preset; the shipped standard preset enables it.': 'Schedule 能力按 Agent 预设挂载；内置的 standard 预设已启用。',
}
