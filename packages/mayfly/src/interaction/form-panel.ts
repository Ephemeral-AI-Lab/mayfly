 ...
 *
 * @module @ephemeral-ai/mayfly/interaction/form-panel
 */

import type { MayflyJson, MayflyUiEvent, MayflyUiNode } from '@ephemeral-ai/mayfly-ui'
...
export class CanonicalFormController implements MayflyFocusable {
  ...
  currentNode(): MayflyUiNode {
    const t: MayflyTranslate = this.options.t ?? interpolateLocaleMessage
    return {
  ...
  private submit(): void {
    ...
    this.onEvent({ kind: 'submit', controlId: 'form-panel', values: values as MayflyJson })
  }
