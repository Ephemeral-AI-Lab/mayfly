/**
 * Native clipboard probes for the `mayfly-paste-image` plugin: win32 through
 ...
 * the `MAYFLY_PASTE_STAGE` environment variable (console codepages mojibake
 ...
 *
 * @module @ephemeral-ai/mayfly/interaction/paste-image-native
 */
...
const POWERSHELL_STAGE_ENV = 'MAYFLY_PASTE_STAGE'
