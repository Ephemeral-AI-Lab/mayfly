/**
 * Package-owned invariant companion for `@ephemeral-ai/mayfly/interaction`.
 * @module @ephemeral-ai/mayfly/interaction/invariant
 */

import type { Context } from '@deepseek-ai/cordis'
import type { InvariantInstaller } from '@deepseek-ai/dsh-invariants'

const PACKAGE_NAME = '@ephemeral-ai/mayfly/interaction'

/** Cordis companion plugin name. */
export const name = 'mayfly-interaction-invariant'
