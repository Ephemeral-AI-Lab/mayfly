/**
 * Tests for the `mayfly-questions` plugin over the real user-questions
...
import * as questionsPlugin from '../../src/interaction/questions-plugin.ts'
...
describe('mayfly-questions provider', () => {
  ...
  it('answers a scoped request for the exact live root agent', async () => {
    ...
    const agent = {
      id: 'mayfly-question-root',
      session: { id: 'mayfly-question-root', header: { delegationDepth: 0 } },
    } as unknown as Agent
...
describe('mayfly-questions plan-review intent', () => {
