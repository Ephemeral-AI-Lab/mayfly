...
import { compareVersions, isVersion, parseVersion, VERSION_FLOOR } from '../../src/interaction/updater/version.ts'
...
describe('updater/version VERSION_FLOOR', () => {
  it('pins the floor at the first Mayfly release', () => {
    expect(VERSION_FLOOR).toBe('0.1.0-alpha.1')
    expect(compareVersions('0.1.0-alpha.0', VERSION_FLOOR)).toBeLessThan(0)
