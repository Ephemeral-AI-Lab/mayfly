/**
 * The width-truth property gate (D48): every invariant the `MayflyComponent`
...
const CORPUS: ReadonlyArray<{ name: string, text: string }> = [
  { name: 'ascii-short', text: 'hello mayfly' },
  ...
  { name: 'cjk-mixed', text: '在 mayfly 里跑 dsh 的 插件 — 渲染宽度守卫 崩溃族 #18 修复' },
