 ...
 * `MayflyComponent` contract — every output line's VISIBLE width stays within
 ...
 *
 * @module mayfly-core-tests/width-scan
 */
...
export const ADVERSARIAL: ReadonlyArray<{ name: string, text: string }> = [
  ...
  { name: 'path-long', text: '/home/x/dev/deepseek-harness-plugin/mayfly/mayfly/.claude/worktrees/some-deep-checkout-name/src' },
]
