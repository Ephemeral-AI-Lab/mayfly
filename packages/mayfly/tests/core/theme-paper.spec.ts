...
import { apply, MayflyThemeService, name, PAPER_COLORS } from '../../src/core/theme-paper.ts'
...
describe('mayfly-theme-paper plugin', () => {
  ...
  it('carries the amber logo sweep, frozen', async () => {
    ...
    expect(logoGradient[7]!('hi')).toBe('\x1b[38;2;240;208;171mhi\x1b[39m')
  })
})
