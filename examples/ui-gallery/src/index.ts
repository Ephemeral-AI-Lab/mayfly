 ...
 *
 * @module @mayfly-example/ui-gallery
 */
...
function contentGroup() {
  return [
    ...
    ui.sections([
      { title: 'Expanded section', body: ui.text('Section bodies stay lightweight content nodes.') },
...
function patternsGroup() {
  return [
    ...
    ui.form({
      id: 'gallery-form',
      fields: [
        { kind: 'input', id: 'gallery-form-name', label: 'Name', value: 'mayfly-gallery', placeholder: 'project name' },
        {
...
function renderGallery() {
  return ui.surface({
    ...
    padding: 1,
    title: 'UI Gallery',
    subtitle: 'Public mayfly-ui builders',
