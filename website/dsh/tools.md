...
::: tip 完整 Schema
每个工具的参数 Schema 由官方[工具目录](https://deepseek-harness.github.io/deepseek-harness/reference/tool-catalog)生成维护——本页是用途速查，字段细节以那边为准。Mayfly 会话里工具调用的呈现见[流式会话与工具卡片](/features/streaming)。
