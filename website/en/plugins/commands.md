...
Mayfly defines no command adapter. Depend on `@deepseek-ai/dsh-commands` and use
...
For the current session, also inject `mayflyCurrentAgent`, obtain the Agent when
