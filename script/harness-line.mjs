...
// constant extracted from packages/mayfly/src/interaction/session-commands.ts
...
if (harnessLine === undefined) {
  console.error('harness-line: HARNESS_LINE constant not found in packages/mayfly/src/interaction/session-commands.ts')
  process.exit(1)
}
