// Real-process mouse smoke: boots the production Mayfly bundle through a
...
const { home, envFor } = installIntoThrowawayProfile(dshBin, 'mayfly-smoke-pty-mouse')
...
const term = pty.spawn(dshBin, ['--profile', 'mayfly-smoke-pty-mouse'], {
  name: 'xterm-256color',
  cols: 40,
  rows: 24,
